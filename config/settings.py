...
LOCAL_APPS = ["maskey.core", "maskey.users"]
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///maskey")}
...
ACCOUNT_FORMS = {"signup": "maskey.users.forms.UserSignupForm"}
